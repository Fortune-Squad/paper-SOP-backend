...
This dictionary defines key terms in the domain to ensure alignment and reduce ambiguity.
...
These are "blue ocean" research directions that are less mainstream but have high potential.

**Total Candidates**: {len(oot_candidates.candidates)}
...
Key resources (datasets, tools, papers, experts) needed for this domain.
