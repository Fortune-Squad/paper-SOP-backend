...
async def test_gate_1_6_check():
    """测试 Gate 1.6 检查"""

    project_id = "physics-driven-compressed-sens-9d772ae8"

    print("=" * 80)
    print("Testing Gate 1.6 Check (After Fix)")
    print("=" * 80)
    ...
    # 执行 Gate 1.6 检查
    print("\n[2] Checking Gate 1.6...")
    result = await project_manager.check_gate(project, "gate_1_6")

    # 显示结果
    print(f"\n[3] Gate 1.6 Check Result:")
...
if __name__ == "__main__":
    asyncio.run(test_gate_1_6_check())
